...
**video_note** | **string** |  | [default to undefined]
...
**length** | **number** | Video width and height, i.e. diameter of the video message | [optional] [default to undefined]
...
```typescript
import { SendVideoNoteRequest } from 'tele_rest';

const instance: SendVideoNoteRequest = {
    chat_id,
    video_note,
