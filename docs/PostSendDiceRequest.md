...
**emoji** | **string** | Emoji on which the dice throw animation is based. Currently, must be one of “🎲”, “🎯”, “🏀”, “⚽”, “🎳”, or “🎰”. Dice can have values 1-6 for “🎲”, “🎯” and “🎳”, values 1-5 for “🏀” and “⚽”, and values 1-64 for “🎰”. Defaults to “🎲” | [optional] [default to EmojiEnum_]
...
```typescript
import { PostSendDiceRequest } from 'tele_rest';

const instance: PostSendDiceRequest = {
    chat_id,
